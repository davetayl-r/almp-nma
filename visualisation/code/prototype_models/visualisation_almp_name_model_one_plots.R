...
# subset data
almp_nma_model_one_forest_plot_data_labour_market_outcomes <- almp_nma_model_one_component_draws |>
  filter(
...
almp_nma_model_one_forest_plot_labels_labour_market_outcomes <- almp_nma_model_one_component_summary |>
  filter(
    outcome_domain == "Labour Force Status",
    !component == "Other Active Components"
  ) |>
...
# create forest plot
almp_nma_model_one_forest_plot_labour_market_outcomes <- almp_nma_model_one_forest_plot_data_labour_market_outcomes |>
  ggplot(
    aes(
      x = effect,
  ...
  geom_text(
    data = mutate_if(
      almp_nma_model_one_forest_plot_labels_labour_market_outcomes,
      is.numeric,
      round,
      3
    ),
...
# export plot
ggsave(
  plot = almp_nma_model_one_forest_plot_labour_market_outcomes,
  filename = "./visualisation/output/prototype_models/almp_nma_model_one_forest_plot_labour_market_outcomes.png",
  height = 10,
  width = 18,
  device = "png",
  type = "cairo-png"
...
# subset data
almp_nma_model_one_forest_plot_data_employment_compensation_outcomes <- almp_nma_model_one_component_draws |>
  filter(
    outcome_domain == "Employment Compensation",
    !component == "Other Active Components"
  )

almp_nma_model_one_forest_plot_labels_employment_compensation_outcomes <- almp_nma_model_one_component_summary |>
  filter(
    outcome_domain == "Employment Compensation",
    !component == "Other Active Components"
  )
...
# create forest plot
almp_nma_model_one_forest_plot_employment_compensation_outcomes <- almp_nma_model_one_forest_plot_data_employment_compensation_outcomes |>
  ggplot(
    aes(
      x = effect,
      y = reorder(outcome, as.numeric(outcome), decreasing = TRUE)
  ...
  geom_text(
    data = mutate_if(
      almp_nma_model_one_forest_plot_labels_employment_compensation_outcomes,
      is.numeric,
      round,
      3
    ),
...
# export plot
ggsave(
  plot = almp_nma_model_one_forest_plot_employment_compensation_outcomes,
  filename = "./visualisation/output/prototype_models/almp_nma_model_one_forest_plot_employment_compensation_outcomes.png",
  height = 6,
  width = 18,
  device = "png",
  type = "cairo-png"
...
# subset data
almp_nma_model_one_forest_plot_data_employment_duration_outcomes <- almp_nma_model_one_component_draws |>
  filter(
    outcome_domain == "Employment Duration",
    !component == "Other Active Components"
  )

almp_nma_model_one_forest_plot_labels_employment_duration_outcomes <- almp_nma_model_one_component_summary |>
  filter(
    outcome_domain == "Employment Duration",
    !component == "Other Active Components"
  )
...
# create forest plot
almp_nma_model_one_forest_plot_employment_duration_outcomes <- almp_nma_model_one_forest_plot_data_employment_duration_outcomes |>
  ggplot(
    aes(
      x = effect,
      y = reorder(outcome, as.numeric(outcome), decreasing = TRUE)
  ...
  geom_text(
    data = mutate_if(
      almp_nma_model_one_forest_plot_labels_employment_duration_outcomes,
      is.numeric,
      round,
      3
    ),
...
# export plot
ggsave(
  plot = almp_nma_model_one_forest_plot_employment_duration_outcomes,
  filename = "./visualisation/output/prototype_models/almp_nma_model_one_forest_plot_employment_duration_outcomes.png",
  height = 5,
  width = 18,
  device = "png",
  type = "cairo-png"
...
# subset data
almp_nma_model_one_forest_plot_data_education_skills_outcomes <- almp_nma_model_one_component_draws |>
  filter(
...
almp_nma_model_one_forest_plot_labels_education_skills_outcomes <- almp_nma_model_one_component_summary |>
  filter(
    outcome_domain == "Education and Skills",
    !component == "Other Active Components"
  ) |>
...
# create forest plot
almp_nma_model_one_forest_plot_education_skills_outcomes <- almp_nma_model_one_forest_plot_data_education_skills_outcomes |>
  ggplot(
    aes(
      x = effect,
      y = reorder(outcome, as.numeric(outcome), decreasing = TRUE)
  ...
  geom_text(
    data = mutate_if(
      almp_nma_model_one_forest_plot_labels_education_skills_outcomes,
      is.numeric,
      round,
      3
    ),
...
# export plot
ggsave(
  plot = almp_nma_model_one_forest_plot_education_skills_outcomes,
  filename = "./visualisation/output/prototype_models/almp_nma_model_one_forest_plot_education_skills_outcomes.png",
  height = 12,
  width = 18,
  device = "png",
  type = "cairo-png"
...
# subset data
almp_nma_model_one_forest_plot_data_hours_worked_outcomes <- almp_nma_model_one_component_draws |>
  filter(
    outcome_domain == "Hours Worked",
    !component == "Other Active Components"
  )

almp_nma_model_one_forest_plot_labels_hours_worked_outcomes <- almp_nma_model_one_component_summary |>
  filter(
    outcome_domain == "Hours Worked",
    !component == "Other Active Components"
  )
...
# create forest plot
almp_nma_model_one_forest_plot_hours_worked_outcomes <- almp_nma_model_one_forest_plot_data_hours_worked_outcomes |>
  ggplot(
    aes(
      x = effect,
      y = outcome
  ...
  geom_text(
    data = mutate_if(
      almp_nma_model_one_forest_plot_labels_hours_worked_outcomes,
      is.numeric,
      round,
      3
    ),
...
# export plot
ggsave(
  plot = almp_nma_model_one_forest_plot_hours_worked_outcomes,
  filename = "./visualisation/output/prototype_models/almp_nma_model_one_forest_plot_hours_worked_outcomes.png",
  height = 4,
  width = 18,
  device = "png",
  type = "cairo-png"
...
# subset data
almp_nma_model_one_forest_plot_data_labour_market_transitions <- almp_nma_model_one_component_draws |>
  filter(
    outcome_domain == "Labour Market Transitions",
    !component == "Other Active Components"
  )

almp_nma_model_one_forest_plot_labels_labour_market_transitions_outcomes <- almp_nma_model_one_component_summary |>
  filter(
    outcome_domain == "Labour Market Transitions",
    !component == "Other Active Components"
  )
...
# create forest plot
almp_nma_model_one_forest_plot_labour_market_transitions <- almp_nma_model_one_forest_plot_data_labour_market_transitions |>
  ggplot(
    aes(
      x = effect,
      y = outcome
  ...
  geom_text(
    data = mutate_if(
      almp_nma_model_one_forest_plot_labels_labour_market_transitions_outcomes,
      is.numeric,
      round,
      3
    ),
...
# export plot
ggsave(
  plot = almp_nma_model_one_forest_plot_labour_market_transitions,
