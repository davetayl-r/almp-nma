...
almp_nma_model_four_data <- almp_nma_additive_model_data |>
...
almp_nma_model_four <- brm(
  formula = almp_nma_model_four_formula,
  data = almp_nma_model_four_data,
  prior = almp_nma_model_four_priors,
  family = gaussian(),
  chains = 2,
  iter = 4000,
  warmup = 2000,
...
# inspect the results
summary(almp_nma_model_four)

# inspect diagnostic plots
#plot(almp_nma_model_four)

pp_check(almp_nma_model_four)
...
almp_nma_model_four_tau_draws <- almp_nma_model_four |>
  gather_draws(
    `sd_.*`,
    regex = TRUE
  ) |>
...
almp_nma_model_four_component_draws <- almp_nma_model_four |>
  gather_draws(
    `b_.*:comp_.*`,
    regex = TRUE
  ) |>
...
almp_nma_model_four_component_summary <- almp_nma_model_four_component_draws |>
  group_by(
    outcome,
    component
  ) |>
...
saveRDS(
  almp_nma_model_four_component_summary,
  "./visualisation/inputs/prototype_models/almp_nma_model_four_component_summary.RDS"
)

saveRDS(
  almp_nma_model_four_component_draws,
  "./visualisation/inputs/prototype_models/almp_nma_model_four_component_draws.RDS"
)

saveRDS(
  almp_nma_model_four_tau_draws,
  "./visualisation/inputs/prototype_models/almp_nma_model_four_tau_draws.RDS"
)
