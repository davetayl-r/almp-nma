...
source("./data_cleaning/code/prep_01_extraction_sheet_download.R")

#-------------------------------------------------------------------------------
# 2. Transform reported results into effect sizes
#-------------------------------------------------------------------------------

source("./data_cleaning/code/prep_02_merge_transformed_es_data.R")

#-------------------------------------------------------------------------------
# 3. Prepare study quality data
#-------------------------------------------------------------------------------

source("./data_cleaning/code/prep_03_prep_study_quality_data.R")

#-------------------------------------------------------------------------------
# 4. Merge outcome and study-level data
#-------------------------------------------------------------------------------

source("./data_cleaning/code/prep_04_merge_outcome_study_level_data.R")

#-------------------------------------------------------------------------------
# 5. Pool results from reporting results across subgroups
#-------------------------------------------------------------------------------

source("./analysis/code/analysis_01_pool_demographic_subgroups.R")
