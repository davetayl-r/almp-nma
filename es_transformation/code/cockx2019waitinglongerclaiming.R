...
# Study ID: cockx2019waitinglongerclaiming                                                   #
#============================================================================================#
...
cockx2019waitinglongerclaiming_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "cockx2019waitinglongerclaiming",
...
cockx2019waitinglongerclaiming_te_continuous <- cockx2019waitinglongerclaiming_outcome_data |>
  filter(
...
cockx2019waitinglongerclaiming_export <- cockx2019waitinglongerclaiming_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  cockx2019waitinglongerclaiming_export,
  file = "./es_transformation/output/cockx2019waitinglongerclaiming.RDS"
)
