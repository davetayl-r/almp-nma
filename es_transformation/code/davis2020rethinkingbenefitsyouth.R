...
# Study ID: davis2020rethinkingbenefitsyouth                                                 #
#============================================================================================#
...
davis2020rethinkingbenefitsyouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "davis2020rethinkingbenefitsyouth"),
...
davis2020rethinkingbenefitsyouth_binary_proportions <- davis2020rethinkingbenefitsyouth_outcome_data |>
  filter(
...
davis2020rethinkingbenefitsyouth_te_continuous <- davis2020rethinkingbenefitsyouth_outcome_data |>
  filter(
...
davis2020rethinkingbenefitsyouth_export <- bind_rows(
  davis2020rethinkingbenefitsyouth_binary_proportions,
  davis2020rethinkingbenefitsyouth_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  davis2020rethinkingbenefitsyouth_export,
  file = "./es_transformation/output/davis2020rethinkingbenefitsyouth.RDS"
)
