...
# Study ID: pessoaecosta2009illustrationreturnstraining                                      #
#============================================================================================#
...
pessoaecosta2009illustrationreturnstraining_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "pessoaecosta2009illustrationreturnstraining",
...
pessoaecosta2009illustrationreturnstraining_te_continuous <- pessoaecosta2009illustrationreturnstraining_outcome_data |>
  filter(
...
pessoaecosta2009illustrationreturnstraining_te_binary <- pessoaecosta2009illustrationreturnstraining_outcome_data |>
  filter(
...
pessoaecosta2009illustrationreturnstraining_export <- bind_rows(
  pessoaecosta2009illustrationreturnstraining_te_continuous,
  pessoaecosta2009illustrationreturnstraining_te_binary
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  pessoaecosta2009illustrationreturnstraining_export,
  file = "./es_transformation/output/pessoaecosta2009illustrationreturnstraining.RDS"
)
