...
# Study ID: oecd2025impactevaluationwage                                                     #
#============================================================================================#
...
oecd2025impactevaluationwage_outcome_data <- outcome_data |>
  filter(
...
oecd2025impactevaluationwage_binary_proportions <- oecd2025impactevaluationwage_outcome_data |>
  filter(
...
oecd2025impactevaluationwage_export <- oecd2025impactevaluationwage_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  oecd2025impactevaluationwage_export,
  file = "./es_transformation/output/oecd2025impactevaluationwage.RDS"
)
