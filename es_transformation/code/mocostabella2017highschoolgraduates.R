...
# Study ID: mocostabella2017highschoolgraduates                                              #
#============================================================================================#
...
mocostabella2017highschoolgraduates_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "mocostabella2017highschoolgraduates",
...
mocostabella2017highschoolgraduates_te_continuous <- mocostabella2017highschoolgraduates_outcome_data |>
  filter(
...
mocostabella2017highschoolgraduates_export <- mocostabella2017highschoolgraduates_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  mocostabella2017highschoolgraduates_export,
  file = "./es_transformation/output/mocostabella2017highschoolgraduates.RDS"
)
