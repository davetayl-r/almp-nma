...
# Study ID: ipsosmori2016evaluationjobsgrowth                                                        #
#============================================================================================#
...
ipsosmori2016evaluationjobsgrowth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "ipsosmori2016evaluationjobsgrowth",
...
ipsosmori2016evaluationjobsgrowth_binary_proportions <- ipsosmori2016evaluationjobsgrowth_outcome_data |>
  filter(
...
ipsosmori2016evaluationjobsgrowth_export <- ipsosmori2016evaluationjobsgrowth_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  ipsosmori2016evaluationjobsgrowth_export,
  file = "./es_transformation/output/ipsosmori2016evaluationjobsgrowth.RDS"
)
