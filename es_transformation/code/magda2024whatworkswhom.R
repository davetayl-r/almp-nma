...
# Study ID: magda2024whatworkswhom                                                           #
#============================================================================================#
...
magda2024whatworkswhom_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "magda2024whatworkswhom"),
...
magda2024whatworkswhom_te_continuous <- magda2024whatworkswhom_outcome_data |>
  filter(
...
magda2024whatworkswhom_export <- magda2024whatworkswhom_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  magda2024whatworkswhom_export,
  file = "./es_transformation/output/magda2024whatworkswhom.RDS"
)
