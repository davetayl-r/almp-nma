...
# Study ID: cummings2018forgingpathfinal                                                     #
#============================================================================================#
...
cummings2018forgingpathfinal_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "cummings2018forgingpathfinal",
...
cummings2018forgingpathfinal_binary_proportions <- cummings2018forgingpathfinal_outcome_data |>
  filter(
...
cummings2018forgingpathfinal_te_continuous <- cummings2018forgingpathfinal_outcome_data |>
...
cummings2018forgingpathfinal_export <- bind_rows(
  cummings2018forgingpathfinal_binary_proportions,
  cummings2018forgingpathfinal_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  cummings2018forgingpathfinal_export,
  file = "./es_transformation/output/cummings2018forgingpathfinal.RDS"
)
