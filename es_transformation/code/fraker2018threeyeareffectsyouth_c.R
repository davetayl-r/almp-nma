...
# Study ID: fraker2018threeyeareffectsyouth_c                                                #
#============================================================================================#
...
fraker2018threeyeareffectsyouth_c_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "fraker2018threeyeareffectsyouth_c",
...
fraker2018threeyeareffectsyouth_c_binary_proportions <- fraker2018threeyeareffectsyouth_c_outcome_data |>
  filter(
...
fraker2018threeyeareffectsyouth_c_te_continuous <- fraker2018threeyeareffectsyouth_c_outcome_data |>
...
fraker2018threeyeareffectsyouth_c_export <- bind_rows(
  fraker2018threeyeareffectsyouth_c_binary_proportions,
  fraker2018threeyeareffectsyouth_c_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  fraker2018threeyeareffectsyouth_c_export,
  file = "./es_transformation/output/fraker2018threeyeareffectsyouth_c.RDS"
)
