...
anderson2019newinsightsback_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "anderson2019newinsightsback",
...
anderson2019newinsightsback_binary_proportions <- anderson2019newinsightsback_outcome_data |>
  filter(
...
anderson2019newinsightsback_export <- anderson2019newinsightsback_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  anderson2019newinsightsback_export,
  file = "./es_transformation/output/anderson2019newinsightsback.RDS"
)
