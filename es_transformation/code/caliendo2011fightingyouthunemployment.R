...
# Study ID: caliendo2011fightingyouthunemployment                                            #
#============================================================================================#
...
caliendo2011fightingyouthunemployment_outcome_data <- outcome_data |>
  filter(
...
caliendo2011fightingyouthunemployment_te_continuous <- caliendo2011fightingyouthunemployment_outcome_data |>
  filter(
...
caliendo2011fightingyouthunemployment_export <- caliendo2011fightingyouthunemployment_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  caliendo2011fightingyouthunemployment_export,
  file = "./es_transformation/output/caliendo2011fightingyouthunemployment.RDS"
)
