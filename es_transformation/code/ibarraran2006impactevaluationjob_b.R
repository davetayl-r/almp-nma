...
# Study ID: ibarraran2006impactevaluationjob_b                                               #
#============================================================================================#
...
ibarraran2006impactevaluationjob_b_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "ibarraran2006impactevaluationjob_b",
...
ibarraran2006impactevaluationjob_b_binary_proportions <- ibarraran2006impactevaluationjob_b_outcome_data |>
  filter(
...
ibarraran2006impactevaluationjob_b_mean_se <- ibarraran2006impactevaluationjob_b_outcome_data |>
  filter(
    esc_type == "Mean SE"
  ) |>
  # random custom function to allow custom functions to vectorise
...
ibarraran2006impactevaluationjob_b_export <- bind_rows(
  ibarraran2006impactevaluationjob_b_binary_proportions,
  ibarraran2006impactevaluationjob_b_mean_se
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  ibarraran2006impactevaluationjob_b_export,
  file = "./es_transformation/output/ibarraran2006impactevaluationjob_b.RDS"
)
