...
# Study ID: chiodi2023locationhousingemployment                                              #
#============================================================================================#
...
chiodi2023locationhousingemployment_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "chiodi2023locationhousingemployment",
...
chiodi2023locationhousingemployment_binary_proportions <- chiodi2023locationhousingemployment_outcome_data |>
  filter(
...
chiodi2023locationhousingemployment_te_continuous <- chiodi2023locationhousingemployment_outcome_data |>
...
chiodi2023locationhousingemployment_export <- bind_rows(
  chiodi2023locationhousingemployment_binary_proportions,
  chiodi2023locationhousingemployment_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  chiodi2023locationhousingemployment_export,
  file = "./es_transformation/output/chiodi2023locationhousingemployment.RDS"
)
