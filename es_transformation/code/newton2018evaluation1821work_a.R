...
# Study ID: newton2018evaluation1821work_a                                                   #
#============================================================================================#
...
newton2018evaluation1821work_a_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "newton2018evaluation1821work_a",
...
newton2018evaluation1821work_a_binary_proportions <- newton2018evaluation1821work_a_outcome_data |>
  filter(
...
newton2018evaluation1821work_a_mean_sd <- newton2018evaluation1821work_a_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
newton2018evaluation1821work_a_export <- bind_rows(
  newton2018evaluation1821work_a_binary_proportions,
  newton2018evaluation1821work_a_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  newton2018evaluation1821work_a_export,
  file = "./es_transformation/output/newton2018evaluation1821work_a.RDS"
)
