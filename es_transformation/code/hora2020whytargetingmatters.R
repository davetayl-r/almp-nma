...
# Study ID: hora2020whytargetingmatters                                                        #
#============================================================================================#
...
hora2020whytargetingmatters_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "hora2020whytargetingmatters",
...
hora2020whytargetingmatters_binary_proportions <- hora2020whytargetingmatters_outcome_data |>
  filter(
...
hora2020whytargetingmatters_export <- hora2020whytargetingmatters_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  hora2020whytargetingmatters_export,
  file = "./es_transformation/output/hora2020whytargetingmatters.RDS"
)
