...
# Study ID: graversen2008activatingunemployedworkers                                         #
#============================================================================================#
...
graversen2008activatingunemployedworkers_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "graversen2008activatingunemployedworkers",
...
graversen2008activatingunemployedworkers_binary_proportions <- graversen2008activatingunemployedworkers_outcome_data |>
  filter(
...
graversen2008activatingunemployedworkers_export <- graversen2008activatingunemployedworkers_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  graversen2008activatingunemployedworkers_export,
  file = "./es_transformation/output/graversen2008activatingunemployedworkers.RDS"
)
