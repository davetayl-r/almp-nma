...
# Study ID: leathers2023mentoringemploymentassistance                                        #
#============================================================================================#
...
leathers2023mentoringemploymentassistance_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "leathers2023mentoringemploymentassistance",
...
leathers2023mentoringemploymentassistance_binary_proportions <- leathers2023mentoringemploymentassistance_outcome_data |>
  filter(
...
leathers2023mentoringemploymentassistance_mean_sd <- leathers2023mentoringemploymentassistance_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
leathers2023mentoringemploymentassistance_export <- bind_rows(
  leathers2023mentoringemploymentassistance_binary_proportions,
  leathers2023mentoringemploymentassistance_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  leathers2023mentoringemploymentassistance_export,
  file = "./es_transformation/output/leathers2023mentoringemploymentassistance.RDS"
)
