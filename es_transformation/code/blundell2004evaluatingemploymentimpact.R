...
# Study ID: blundell2004evaluatingemploymentimpact                                           #
#============================================================================================#
...
blundell2004evaluatingemploymentimpact_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "blundell2004evaluatingemploymentimpact",
...
blundell2004evaluatingemploymentimpact_te_continuous <- blundell2004evaluatingemploymentimpact_outcome_data |>
  filter(
...
blundell2004evaluatingemploymentimpact_export <- blundell2004evaluatingemploymentimpact_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  blundell2004evaluatingemploymentimpact_export,
  file = "./es_transformation/output/blundell2004evaluatingemploymentimpact.RDS"
)
