...
# Study ID: cave1993jobstartfinalreport                                                      #
#============================================================================================#
...
cave1993jobstartfinalreport_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "cave1993jobstartfinalreport",
...
cave1993jobstartfinalreport_binary_proportions <- cave1993jobstartfinalreport_outcome_data |>
  filter(
...
cave1993jobstartfinalreport_export <- cave1993jobstartfinalreport_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  cave1993jobstartfinalreport_export,
  file = "./es_transformation/output/cave1993jobstartfinalreport.RDS"
)
