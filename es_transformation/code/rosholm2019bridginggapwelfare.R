...
rosholm2019bridginggapwelfare_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "rosholm2019bridginggapwelfare",
...
rosholm2019bridginggapwelfare_binary_proportions <- rosholm2019bridginggapwelfare_outcome_data |>
  filter(
...
rosholm2019bridginggapwelfare_te_continuous <- rosholm2019bridginggapwelfare_outcome_data |>
  filter(
...
rosholm2019bridginggapwelfare_export <- bind_rows(
  rosholm2019bridginggapwelfare_binary_proportions,
  rosholm2019bridginggapwelfare_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  rosholm2019bridginggapwelfare_export,
  file = "./es_transformation/output/rosholm2019bridginggapwelfare.RDS"
)
