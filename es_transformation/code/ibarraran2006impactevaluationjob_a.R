...
# Study ID: ibarraran2006impactevaluationjob_a                                               #
#============================================================================================#
...
ibarraran2006impactevaluationjob_a_outcome_data <- outcome_data |>
  filter(
...
ibarraran2006impactevaluationjob_a_binary_proportions <- ibarraran2006impactevaluationjob_a_outcome_data |>
  filter(
...
ibarraran2006impactevaluationjob_a_mean_se <- ibarraran2006impactevaluationjob_a_outcome_data |>
  filter(
    esc_type == "Mean SE"
  ) |>
  # random custom function to allow custom functions to vectorise
...
ibarraran2006impactevaluationjob_a_export <- bind_rows(
  ibarraran2006impactevaluationjob_a_binary_proportions,
  ibarraran2006impactevaluationjob_a_mean_se
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  ibarraran2006impactevaluationjob_a_export,
  file = "./es_transformation/output/ibarraran2006impactevaluationjob_a.RDS"
)
