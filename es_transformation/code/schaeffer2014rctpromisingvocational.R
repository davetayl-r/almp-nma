...
schaeffer2014rctpromisingvocational_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "schaeffer2014rctpromisingvocational",
...
schaeffer2014rctpromisingvocational_binary_proportions <- schaeffer2014rctpromisingvocational_outcome_data |>
  filter(
...
schaeffer2014rctpromisingvocational_mean_sd <- schaeffer2014rctpromisingvocational_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
schaeffer2014rctpromisingvocational_export <- bind_rows(
  schaeffer2014rctpromisingvocational_binary_proportions,
  schaeffer2014rctpromisingvocational_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  schaeffer2014rctpromisingvocational_export,
  file = "./es_transformation/output/schaeffer2014rctpromisingvocational.RDS"
)
