...
# Study ID: zamora2018arejobsearch                                                           #
#============================================================================================#
...
zamora2018arejobsearch_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "zamora2018arejobsearch",
...
zamora2018arejobsearch_binary_proportions <- zamora2018arejobsearch_outcome_data |>
  filter(
...
zamora2018arejobsearch_export <- zamora2018arejobsearch_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  zamora2018arejobsearch_export,
  file = "./es_transformation/output/zamora2018arejobsearch.RDS"
)
