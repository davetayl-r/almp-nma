...
# Study ID: cammeraat2022preventingneetsgreat                                                #
#============================================================================================#
...
cammeraat2022preventingneetsgreat_outcome_data <- outcome_data |>
  filter(
...
cammeraat2022preventingneetsgreat_te_continuous <- cammeraat2022preventingneetsgreat_outcome_data |>
  filter(
...
cammeraat2022preventingneetsgreat_export <- cammeraat2022preventingneetsgreat_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  cammeraat2022preventingneetsgreat_export,
  file = "./es_transformation/output/cammeraat2022preventingneetsgreat.RDS"
)
