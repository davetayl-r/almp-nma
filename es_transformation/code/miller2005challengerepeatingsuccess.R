...
# Study ID: miller2005challengerepeatingsuccess                                              #
#============================================================================================#
...
miller2005challengerepeatingsuccess_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "miller2005challengerepeatingsuccess",
...
miller2005challengerepeatingsuccess_binary_proportions <- miller2005challengerepeatingsuccess_outcome_data |>
  filter(
...
miller2005challengerepeatingsuccess_te_continuous <- miller2005challengerepeatingsuccess_outcome_data |>
...
miller2005challengerepeatingsuccess_export <- bind_rows(
  miller2005challengerepeatingsuccess_binary_proportions,
  miller2005challengerepeatingsuccess_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  miller2005challengerepeatingsuccess_export,
  file = "./es_transformation/output/miller2005challengerepeatingsuccess.RDS"
)
