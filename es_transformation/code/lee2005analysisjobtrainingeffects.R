...
# Study ID: lee2005analysisjobtrainingeffects                                                #
#============================================================================================#
...
lee2005analysisjobtrainingeffects_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "lee2005analysisjobtrainingeffects",
...
lee2005analysisjobtrainingeffects_te_continuous <- lee2005analysisjobtrainingeffects_outcome_data |>
  filter(
...
lee2005analysisjobtrainingeffects_te_binary <- lee2005analysisjobtrainingeffects_outcome_data |>
  filter(
...
lee2005analysisjobtrainingeffects_export <- bind_rows(
  lee2005analysisjobtrainingeffects_te_continuous,
  lee2005analysisjobtrainingeffects_te_binary
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  lee2005analysisjobtrainingeffects_export,
  file = "./es_transformation/output/lee2005analysisjobtrainingeffects.RDS"
)
