...
# Study ID: patnaik2021promotingreadinessminors                                              #
#============================================================================================#
...
patnaik2021promotingreadinessminors_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "patnaik2021promotingreadinessminors"),
...
patnaik2021promotingreadinessminors_binary_proportions <- patnaik2021promotingreadinessminors_outcome_data |>
  filter(
...
patnaik2021promotingreadinessminors_te_continuous <- patnaik2021promotingreadinessminors_outcome_data |>
  filter(
...
patnaik2021promotingreadinessminors_export <- bind_rows(
  patnaik2021promotingreadinessminors_binary_proportions,
  patnaik2021promotingreadinessminors_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  patnaik2021promotingreadinessminors_export,
  file = "./es_transformation/output/patnaik2021promotingreadinessminors.RDS"
)
