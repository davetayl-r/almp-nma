...
# Study ID: hillage2008activityagreementsevaluation                                          #
#============================================================================================#
...
hillage2008activityagreementsevaluation_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "hillage2008activityagreementsevaluation",
...
hillage2008activityagreementsevaluation_binary_proportions <- hillage2008activityagreementsevaluation_outcome_data |>
  filter(
...
hillage2008activityagreementsevaluation_export <- hillage2008activityagreementsevaluation_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  hillage2008activityagreementsevaluation_export,
  file = "./es_transformation/output/hillage2008activityagreementsevaluation.RDS"
)
