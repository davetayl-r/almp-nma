...
# Study ID: wehman2023effects9monthmilitarybase                                              #
#============================================================================================#
...
wehman2023effects9monthmilitarybase_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "wehman2023effects9monthmilitarybase",
...
wehman2023effects9monthmilitarybase_binary_proportions <- wehman2023effects9monthmilitarybase_outcome_data |>
  filter(
...
wehman2023effects9monthmilitarybase_mean_se <- wehman2023effects9monthmilitarybase_outcome_data |>
  filter(
    esc_type == "Mean SE"
  ) |>
  # random custom function to allow custom functions to vectorise
...
wehman2023effects9monthmilitarybase_export <- bind_rows(
  wehman2023effects9monthmilitarybase_binary_proportions,
  wehman2023effects9monthmilitarybase_mean_se
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  wehman2023effects9monthmilitarybase_export,
  file = "./es_transformation/output/wehman2023effects9monthmilitarybase.RDS"
)
