...
dwp2025sectorbasedworkacademy_outcome_data <- outcome_data |>
  filter(
...
dwp2025sectorbasedworkacademy_binary_proportions <- dwp2025sectorbasedworkacademy_outcome_data |>
  filter(
...
dwp2025sectorbasedworkacademy_export <- dwp2025sectorbasedworkacademy_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  dwp2025sectorbasedworkacademy_export,
  file = "./es_transformation/output/dwp2025sectorbasedworkacademy.RDS"
)
