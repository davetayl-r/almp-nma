...
# Study ID: dixon2016evaluationimpactyouth                                                   #
#============================================================================================#
...
dixon2016evaluationimpactyouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "dixon2016evaluationimpactyouth"),
...
dixon2016evaluationimpactyouth_binary_proportions <- dixon2016evaluationimpactyouth_outcome_data |>
  filter(
...
dixon2016evaluationimpactyouth_export <- dixon2016evaluationimpactyouth_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  dixon2016evaluationimpactyouth_export,
  file = "./es_transformation/output/dixon2016evaluationimpactyouth.RDS"
)
