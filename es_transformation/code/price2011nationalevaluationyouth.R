...
# Study ID: price2011nationalevaluationyouth                                                        #
#============================================================================================#
...
price2011nationalevaluationyouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "price2011nationalevaluationyouth",
...
price2011nationalevaluationyouth_binary_proportions <- price2011nationalevaluationyouth_outcome_data |>
  filter(
...
price2011nationalevaluationyouth_te_continuous <- price2011nationalevaluationyouth_outcome_data |>
...
price2011nationalevaluationyouth_export <- bind_rows(
  price2011nationalevaluationyouth_binary_proportions,
  price2011nationalevaluationyouth_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  price2011nationalevaluationyouth_export,
  file = "./es_transformation/output/price2011nationalevaluationyouth.RDS"
)
