...
# Study ID: knight2002evaluationaustralianwage                                               #
#============================================================================================#
...
knight2002evaluationaustralianwage_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "knight2002evaluationaustralianwage",
...
knight2002evaluationaustralianwage_te_binary <- knight2002evaluationaustralianwage_outcome_data |>
  filter(
...
knight2002evaluationaustralianwage_export <- knight2002evaluationaustralianwage_te_binary |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  knight2002evaluationaustralianwage_export,
  file = "./es_transformation/output/knight2002evaluationaustralianwage.RDS"
)
