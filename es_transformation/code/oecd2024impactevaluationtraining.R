...
# Study ID: oecd2024impactevaluationtraining                                                 #
#============================================================================================#
...
oecd2024impactevaluationtraining_outcome_data <- outcome_data |>
  filter(
...
oecd2024impactevaluationtraining_binary_proportions <- oecd2024impactevaluationtraining_outcome_data |>
  filter(
...
oecd2024impactevaluationtraining_export <- oecd2024impactevaluationtraining_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  oecd2024impactevaluationtraining_export,
  file = "./es_transformation/output/oecd2024impactevaluationtraining.RDS"
)
