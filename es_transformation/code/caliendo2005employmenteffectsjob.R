...
# Study ID: caliendo2005employmenteffectsjob                                                 #
#============================================================================================#
...
caliendo2005employmenteffectsjob_outcome_data <- outcome_data |>
  filter(
...
caliendo2005employmenteffectsjob_te_continuous <- caliendo2005employmenteffectsjob_outcome_data |>
  filter(
...
caliendo2005employmenteffectsjob_export <- caliendo2005employmenteffectsjob_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  caliendo2005employmenteffectsjob_export,
  file = "./es_transformation/output/caliendo2005employmenteffectsjob.RDS"
)
