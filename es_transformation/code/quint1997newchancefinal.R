...
# Study ID: quint1997newchancefinal                                                          #
#============================================================================================#
...
quint1997newchancefinal_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "quint1997newchancefinal",
...
quint1997newchancefinal_binary_proportions <- quint1997newchancefinal_outcome_data |>
  filter(
...
quint1997newchancefinal_te_continuous <- quint1997newchancefinal_outcome_data |>
...
quint1997newchancefinal_export <- bind_rows(
  quint1997newchancefinal_binary_proportions,
  quint1997newchancefinal_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  quint1997newchancefinal_export,
  file = "./es_transformation/output/quint1997newchancefinal.RDS"
)
