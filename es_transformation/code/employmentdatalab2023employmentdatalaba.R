...
# Study ID: employmentdatalab2023employmentdatalaba                                          #
#============================================================================================#
...
employmentdatalab2023employmentdatalaba_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "employmentdatalab2023employmentdatalaba",
...
employmentdatalab2023employmentdatalaba_binary_proportions <- employmentdatalab2023employmentdatalaba_outcome_data |>
  filter(
...
employmentdatalab2023employmentdatalaba_te_continuous <- employmentdatalab2023employmentdatalaba_outcome_data |>
...
employmentdatalab2023employmentdatalaba_export <- bind_rows(
  employmentdatalab2023employmentdatalaba_binary_proportions,
  employmentdatalab2023employmentdatalaba_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  employmentdatalab2023employmentdatalaba_export,
  file = "./es_transformation/output/employmentdatalab2023employmentdatalaba.RDS"
)
