...
# Study ID: hollenbeck2016netimpactbenefitcost                                               #
#============================================================================================#
...
hollenbeck2016netimpactbenefitcost_outcome_data <- outcome_data |>
  filter(
...
hollenbeck2016netimpactbenefitcost_binary_proportions <- hollenbeck2016netimpactbenefitcost_outcome_data |>
  filter(
...
hollenbeck2016netimpactbenefitcost_export <- hollenbeck2016netimpactbenefitcost_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  hollenbeck2016netimpactbenefitcost_export,
  file = "./es_transformation/output/hollenbeck2016netimpactbenefitcost.RDS"
)
