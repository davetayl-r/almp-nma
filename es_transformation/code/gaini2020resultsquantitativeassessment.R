...
# Study ID: gaini2020resultsquantitativeassessment                                           #
#============================================================================================#
...
gaini2020resultsquantitativeassessment_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "gaini2020resultsquantitativeassessment",
...
gaini2020resultsquantitativeassessment_te_continuous <- gaini2020resultsquantitativeassessment_outcome_data |>
  filter(
...
gaini2020resultsquantitativeassessment_export <- gaini2020resultsquantitativeassessment_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  gaini2020resultsquantitativeassessment_export,
  file = "./es_transformation/output/gaini2020resultsquantitativeassessment.RDS"
)
