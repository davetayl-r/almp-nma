...
# Study ID: barden2018newperspectivescreating                                                #
#============================================================================================#
...
barden2018newperspectivescreating_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "barden2018newperspectivescreating",
...
barden2018newperspectivescreating_binary_proportions <- barden2018newperspectivescreating_outcome_data |>
  filter(
...
barden2018newperspectivescreating_te_continuous <- barden2018newperspectivescreating_outcome_data |>
  filter(
...
barden2018newperspectivescreating_export <- bind_rows(
  barden2018newperspectivescreating_binary_proportions,
  barden2018newperspectivescreating_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  barden2018newperspectivescreating_export,
  file = "./es_transformation/output/barden2018newperspectivescreating.RDS"
)
