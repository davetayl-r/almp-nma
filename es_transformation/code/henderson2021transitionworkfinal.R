...
# Study ID: henderson2021transitionworkfinal                                                 #
#============================================================================================#
...
henderson2021transitionworkfinal_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "henderson2021transitionworkfinal",
...
henderson2021transitionworkfinal_binary_proportions <- henderson2021transitionworkfinal_outcome_data |>
  filter(
...
henderson2021transitionworkfinal_export <- henderson2021transitionworkfinal_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  henderson2021transitionworkfinal_export,
  file = "./es_transformation/output/henderson2021transitionworkfinal.RDS"
)
