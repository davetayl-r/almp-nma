...
# Study ID: employmentdatalab2024employmentdatalab_a                                         #
#============================================================================================#
...
employmentdatalab2024employmentdatalab_a_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "employmentdatalab2024employmentdatalab_a",
...
employmentdatalab2024employmentdatalab_a_binary_proportions <- employmentdatalab2024employmentdatalab_a_outcome_data |>
  filter(
...
employmentdatalab2024employmentdatalab_a_export <- employmentdatalab2024employmentdatalab_a_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  employmentdatalab2024employmentdatalab_a_export,
  file = "./es_transformation/output/employmentdatalab2024employmentdatalab_a.RDS"
)
