...
# Study ID: employmentdatalab2023employmentdatalab                                           #
#============================================================================================#
...
employmentdatalab2023employmentdatalab_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "employmentdatalab2023employmentdatalab",
...
employmentdatalab2023employmentdatalab_binary_proportions <- employmentdatalab2023employmentdatalab_outcome_data |>
  filter(
...
employmentdatalab2023employmentdatalab_te_continuous <- employmentdatalab2023employmentdatalab_outcome_data |>
...
employmentdatalab2023employmentdatalab_export <- bind_rows(
  employmentdatalab2023employmentdatalab_binary_proportions,
  employmentdatalab2023employmentdatalab_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  employmentdatalab2023employmentdatalab_export,
  file = "./es_transformation/output/employmentdatalab2023employmentdatalab.RDS"
)
