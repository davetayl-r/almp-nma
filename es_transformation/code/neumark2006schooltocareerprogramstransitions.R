...
# Study ID: neumark2006schooltocareerprogramstransitions                                     #
#============================================================================================#
...
neumark2006schooltocareerprogramstransitions_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "neumark2006schooltocareerprogramstransitions"),
...
neumark2006schooltocareerprogramstransitions_te_continuous <- neumark2006schooltocareerprogramstransitions_outcome_data |>
  filter(
...
neumark2006schooltocareerprogramstransitions_export <- neumark2006schooltocareerprogramstransitions_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  neumark2006schooltocareerprogramstransitions_export,
  file = "./es_transformation/output/neumark2006schooltocareerprogramstransitions.RDS"
)
