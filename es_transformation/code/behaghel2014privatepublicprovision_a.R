...
# Study ID: behaghel2014privatepublicprovision_a                                             #
#============================================================================================#
...
behaghel2014privatepublicprovision_a_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "behaghel2014privatepublicprovision_a",
...
behaghel2014privatepublicprovision_a_binary_proportions <- behaghel2014privatepublicprovision_a_outcome_data |>
  filter(
...
behaghel2014privatepublicprovision_a_export <- behaghel2014privatepublicprovision_a_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  behaghel2014privatepublicprovision_a_export,
  file = "./es_transformation/output/behaghel2014privatepublicprovision_a.RDS"
)
