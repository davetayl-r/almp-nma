...
# Study ID: atwell2023usingintegrateddata                                                    #
#============================================================================================#
...
atwell2023usingintegrateddata_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "atwell2023usingintegrateddata"),
...
atwell2023usingintegrateddata_binary_proportions <- atwell2023usingintegrateddata_outcome_data |>
  filter(
...
atwell2023usingintegrateddata_export <- atwell2023usingintegrateddata_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  atwell2023usingintegrateddata_export,
  file = "./es_transformation/output/atwell2023usingintegrateddata.RDS"
)
