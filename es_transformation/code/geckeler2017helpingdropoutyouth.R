...
geckeler2017helpingdropoutyouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "geckeler2017helpingdropoutyouth",
...
geckeler2017helpingdropoutyouth_binary_proportions <- geckeler2017helpingdropoutyouth_outcome_data |>
  filter(
...
geckeler2017helpingdropoutyouth_export <- geckeler2017helpingdropoutyouth_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  geckeler2017helpingdropoutyouth_export,
  file = "./es_transformation/output/geckeler2017helpingdropoutyouth.RDS"
)
