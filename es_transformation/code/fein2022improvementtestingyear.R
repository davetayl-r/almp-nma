...
# Study ID: fein2022improvementtestingyear                                                   #
#============================================================================================#
...
fein2022improvementtestingyear_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "fein2022improvementtestingyear",
...
fein2022improvementtestingyear_binary_proportions <- fein2022improvementtestingyear_outcome_data |>
  filter(
...
fein2022improvementtestingyear_te_continuous <- fein2022improvementtestingyear_outcome_data |>
  filter(
...
fein2022improvementtestingyear_export <- bind_rows(
  fein2022improvementtestingyear_binary_proportions,
  fein2022improvementtestingyear_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  fein2022improvementtestingyear_export,
  file = "./es_transformation/output/fein2022improvementtestingyear.RDS"
)
