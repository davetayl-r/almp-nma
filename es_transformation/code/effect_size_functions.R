...
pool_studies <- function(dat, study_ids, output_study_id) {
  ...
  pooled <- dat_sub |>
    ...
    dplyr::summarise(
      ...
      qa_randomised_q1 = dplyr::first(.data$qa_randomised_q1),
      qa_randomised_q2 = dplyr::first(.data$qa_randomised_q2),
      qa_randomised_q3 = dplyr::first(.data$qa_randomised_q3),
      qa_randomised_q4 = dplyr::first(.data$qa_randomised_q4),
      qa_randomised_q5 = dplyr::first(.data$qa_randomised_q5),
      qa_randomised_q6 = dplyr::first(.data$qa_randomised_q6),
      qa_randomised_q7 = dplyr::first(.data$qa_randomised_q7),
      qa_randomised_q8 = dplyr::first(.data$qa_randomised_q8),
      qa_randomised_q9 = dplyr::first(.data$qa_randomised_q9),
      qa_randomised_q10 = dplyr::first(.data$qa_randomised_q10),
      qa_randomised_q11 = dplyr::first(.data$qa_randomised_q11),
      qa_randomised_q12 = dplyr::first(.data$qa_randomised_q12),
      qa_randomised_q13 = dplyr::first(.data$qa_randomised_q13),
      qa_non_randomised_q1 = dplyr::first(.data$qa_non_randomised_q1),
      qa_non_randomised_q2 = dplyr::first(.data$qa_non_randomised_q2),
      qa_non_randomised_q3 = dplyr::first(.data$qa_non_randomised_q3),
      qa_non_randomised_q4 = dplyr::first(.data$qa_non_randomised_q4),
      qa_non_randomised_q5 = dplyr::first(.data$qa_non_randomised_q5),
      qa_non_randomised_q6 = dplyr::first(.data$qa_non_randomised_q6),
      qa_non_randomised_q7 = dplyr::first(.data$qa_non_randomised_q7),
      qa_non_randomised_q8 = dplyr::first(.data$qa_non_randomised_q8),
      qa_non_randomised_q9 = dplyr::first(.data$qa_non_randomised_q9),
      .groups = "drop"
    ) |>
