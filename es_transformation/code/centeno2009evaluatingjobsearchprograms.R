...
# Study ID: centeno2009evaluatingjobsearchprograms                                           #
#============================================================================================#
...
centeno2009evaluatingjobsearchprograms_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "centeno2009evaluatingjobsearchprograms",
...
centeno2009evaluatingjobsearchprograms_te_continuous <- centeno2009evaluatingjobsearchprograms_outcome_data |>
  filter(
...
centeno2009evaluatingjobsearchprograms_export <- centeno2009evaluatingjobsearchprograms_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  centeno2009evaluatingjobsearchprograms_export,
  file = "./es_transformation/output/centeno2009evaluatingjobsearchprograms.RDS"
)
