...
# Study ID: gelber2016effectsyouthemployment                                                 #
#============================================================================================#
...
gelber2016effectsyouthemployment_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "gelber2016effectsyouthemployment",
...
gelber2016effectsyouthemployment_te_continuous <- gelber2016effectsyouthemployment_outcome_data |>
  filter(
...
gelber2016effectsyouthemployment_export <- gelber2016effectsyouthemployment_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  gelber2016effectsyouthemployment_export,
  file = "./es_transformation/output/gelber2016effectsyouthemployment.RDS"
)
