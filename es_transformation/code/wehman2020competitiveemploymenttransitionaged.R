...
# Study ID: wehman2020competitiveemploymenttransitionaged                                    #
#============================================================================================#
...
wehman2020competitiveemploymenttransitionaged_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "wehman2020competitiveemploymenttransitionaged",
...
wehman2020competitiveemploymenttransitionaged_binary_proportions <- wehman2020competitiveemploymenttransitionaged_outcome_data |>
  filter(
...
wehman2020competitiveemploymenttransitionaged_mean_sd <- wehman2020competitiveemploymenttransitionaged_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
wehman2020competitiveemploymenttransitionaged_export <- bind_rows(
  wehman2020competitiveemploymenttransitionaged_binary_proportions,
  wehman2020competitiveemploymenttransitionaged_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  wehman2020competitiveemploymenttransitionaged_export,
  file = "./es_transformation/output/wehman2020competitiveemploymenttransitionaged.RDS"
)
