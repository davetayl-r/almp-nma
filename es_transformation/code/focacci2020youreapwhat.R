...
# Study ID: focacci2020youreapwhat                                                           #
#============================================================================================#
...
focacci2020youreapwhat_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "focacci2020youreapwhat",
...
focacci2020youreapwhat_te_binary <- focacci2020youreapwhat_outcome_data |>
  filter(
...
focacci2020youreapwhat_export <- focacci2020youreapwhat_te_binary |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  focacci2020youreapwhat_export,
  file = "./es_transformation/output/focacci2020youreapwhat.RDS"
)
