...
# Study ID: hamalainen2007vocationallabourmarket                                             #
#============================================================================================#
...
hamalainen2007vocationallabourmarket_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "hamalainen2007vocationallabourmarket",
...
hamalainen2007vocationallabourmarket_te_continuous <- hamalainen2007vocationallabourmarket_outcome_data |>
  filter(
...
hamalainen2007vocationallabourmarket_export <- hamalainen2007vocationallabourmarket_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  hamalainen2007vocationallabourmarket_export,
  file = "./es_transformation/output/hamalainen2007vocationallabourmarket.RDS"
)
