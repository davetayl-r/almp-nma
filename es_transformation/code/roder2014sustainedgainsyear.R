...
# Study ID: roder2014sustainedgainsyear                                                      #
#============================================================================================#
...
roder2014sustainedgainsyear_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "roder2014sustainedgainsyear",
...
roder2014sustainedgainsyear_binary_proportions <- roder2014sustainedgainsyear_outcome_data |>
  filter(
...
roder2014sustainedgainsyear_export <- roder2014sustainedgainsyear_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  roder2014sustainedgainsyear_export,
  file = "./es_transformation/output/roder2014sustainedgainsyear.RDS"
)
