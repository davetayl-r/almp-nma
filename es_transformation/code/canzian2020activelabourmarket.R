...
canzian2020activelabourmarket_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "canzian2020activelabourmarket",
...
canzian2020activelabourmarket_te_binary <- canzian2020activelabourmarket_outcome_data |>
  filter(
...
canzian2020activelabourmarket_export <- canzian2020activelabourmarket_te_binary |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  canzian2020activelabourmarket_export,
  file = "./es_transformation/output/canzian2020activelabourmarket.RDS"
)
