...
# Study ID: legallo2017doesenhancedmobility                                                  #
#============================================================================================#
...
legallo2017doesenhancedmobility_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "legallo2017doesenhancedmobility",
...
legallo2017doesenhancedmobility_te_continuous <- legallo2017doesenhancedmobility_outcome_data |>
  filter(
...
legallo2017doesenhancedmobility_export <- legallo2017doesenhancedmobility_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  legallo2017doesenhancedmobility_export,
  file = "./es_transformation/output/legallo2017doesenhancedmobility.RDS"
)
