...
# Study ID: dorsett2022preapprenticeshiptrainingyoung                                        #
#============================================================================================#
...
dorsett2022preapprenticeshiptrainingyoung_outcome_data <- outcome_data |>
  filter(
...
dorsett2022preapprenticeshiptrainingyoung_binary_proportions <- dorsett2022preapprenticeshiptrainingyoung_outcome_data |>
  filter(
...
dorsett2022preapprenticeshiptrainingyoung_te_binary <- dorsett2022preapprenticeshiptrainingyoung_outcome_data |>
  filter(
...
dorsett2022preapprenticeshiptrainingyoung_export <- bind_rows(
  dorsett2022preapprenticeshiptrainingyoung_binary_proportions,
  dorsett2022preapprenticeshiptrainingyoung_te_binary
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  dorsett2022preapprenticeshiptrainingyoung_export,
  file = "./es_transformation/output/dorsett2022preapprenticeshiptrainingyoung.RDS"
)
