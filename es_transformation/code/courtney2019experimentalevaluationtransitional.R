...
# Study ID: courtney2019experimentalevaluationtransitional                                   #
#============================================================================================#
...
courtney2019experimentalevaluationtransitional_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "courtney2019experimentalevaluationtransitional",
...
courtney2019experimentalevaluationtransitional_binary_proportions <- courtney2019experimentalevaluationtransitional_outcome_data |>
  filter(
...
courtney2019experimentalevaluationtransitional_te_continuous <- courtney2019experimentalevaluationtransitional_outcome_data |>
...
courtney2019experimentalevaluationtransitional_export <- bind_rows(
  courtney2019experimentalevaluationtransitional_binary_proportions,
  courtney2019experimentalevaluationtransitional_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  courtney2019experimentalevaluationtransitional_export,
  file = "./es_transformation/output/courtney2019experimentalevaluationtransitional.RDS"
)
