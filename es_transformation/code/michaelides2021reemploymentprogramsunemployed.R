...
# Study ID: michaelides2021reemploymentprogramsunemployed                                    #
#============================================================================================#
...
michaelides2021reemploymentprogramsunemployed_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "michaelides2021reemploymentprogramsunemployed"),
...
michaelides2021reemploymentprogramsunemployed_te_continuous <- michaelides2021reemploymentprogramsunemployed_outcome_data |>
  filter(
...
michaelides2021reemploymentprogramsunemployed_export <- michaelides2021reemploymentprogramsunemployed_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  michaelides2021reemploymentprogramsunemployed_export,
  file = "./es_transformation/output/michaelides2021reemploymentprogramsunemployed.RDS"
)
