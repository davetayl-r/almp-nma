...
# Study ID: iwanaga2023effectssupportedemployment                                            #
#============================================================================================#
...
iwanaga2023effectssupportedemployment_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "iwanaga2023effectssupportedemployment",
...
iwanaga2023effectssupportedemployment_binary_proportions <- iwanaga2023effectssupportedemployment_outcome_data |>
  filter(
...
iwanaga2023effectssupportedemployment_mean_sd <- iwanaga2023effectssupportedemployment_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
iwanaga2023effectssupportedemployment_export <- bind_rows(
  iwanaga2023effectssupportedemployment_binary_proportions,
  iwanaga2023effectssupportedemployment_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  iwanaga2023effectssupportedemployment_export,
  file = "./es_transformation/output/iwanaga2023effectssupportedemployment.RDS"
)
