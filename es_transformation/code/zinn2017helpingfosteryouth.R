...
# Study ID: zinn2017helpingfosteryouth                                                        #
#============================================================================================#
...
zinn2017helpingfosteryouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "zinn2017helpingfosteryouth",
...
zinn2017helpingfosteryouth_binary_proportions <- zinn2017helpingfosteryouth_outcome_data |>
  filter(
...
zinn2017helpingfosteryouth_mean_sd <- zinn2017helpingfosteryouth_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
zinn2017helpingfosteryouth_export <- bind_rows(
  zinn2017helpingfosteryouth_binary_proportions,
  zinn2017helpingfosteryouth_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  zinn2017helpingfosteryouth_export,
  file = "./es_transformation/output/zinn2017helpingfosteryouth.RDS"
)
