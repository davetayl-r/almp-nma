...
# Study ID: meager2003evaluationbusinessstartup                                              #
#============================================================================================#
...
meager2003evaluationbusinessstartup_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "meager2003evaluationbusinessstartup",
...
meager2003evaluationbusinessstartup_binary_proportions <- meager2003evaluationbusinessstartup_outcome_data |>
  filter(
...
meager2003evaluationbusinessstartup_export <- meager2003evaluationbusinessstartup_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  meager2003evaluationbusinessstartup_export,
  file = "./es_transformation/output/meager2003evaluationbusinessstartup.RDS"
)
