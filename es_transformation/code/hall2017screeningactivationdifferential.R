...
hall2017screeningactivationdifferential_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "hall2017screeningactivationdifferential",
...
hall2017screeningactivationdifferential_binary_proportions <- hall2017screeningactivationdifferential_outcome_data |>
  filter(
...
hall2017screeningactivationdifferential_export <- hall2017screeningactivationdifferential_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  hall2017screeningactivationdifferential_export,
  file = "./es_transformation/output/hall2017screeningactivationdifferential.RDS"
)
