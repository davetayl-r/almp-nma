...
# Study ID: rodriguezplanas2012longertermimpactsmentoring                                    #
#============================================================================================#
...
rodriguezplanas2012longertermimpactsmentoring_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "rodriguezplanas2012longertermimpactsmentoring",
...
rodriguezplanas2012longertermimpactsmentoring_binary_proportions <- rodriguezplanas2012longertermimpactsmentoring_outcome_data |>
  filter(
...
rodriguezplanas2012longertermimpactsmentoring_te_continuous <- rodriguezplanas2012longertermimpactsmentoring_outcome_data |>
  filter(
...
rodriguezplanas2012longertermimpactsmentoring_export <- bind_rows(
  rodriguezplanas2012longertermimpactsmentoring_binary_proportions,
  rodriguezplanas2012longertermimpactsmentoring_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  rodriguezplanas2012longertermimpactsmentoring_export,
  file = "./es_transformation/output/rodriguezplanas2012longertermimpactsmentoring.RDS"
)
