...
# Study ID: mamede2015esfsupportingyouth                                                        #
#============================================================================================#
...
mamede2015esfsupportingyouth_outcome_data <- outcome_data |>
  filter(
...
mamede2015esfsupportingyouth_te_continuous <- mamede2015esfsupportingyouth_outcome_data |>
  filter(
...
mamede2015esfsupportingyouth_export <- mamede2015esfsupportingyouth_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  mamede2015esfsupportingyouth_export,
  file = "./es_transformation/output/mamede2015esfsupportingyouth.RDS"
)
