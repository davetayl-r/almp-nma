...
# Study ID: fraker2018threeyeareffectsyouth_e                                                #
#============================================================================================#
...
fraker2018threeyeareffectsyouth_e_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "fraker2018threeyeareffectsyouth_e",
...
fraker2018threeyeareffectsyouth_e_binary_proportions <- fraker2018threeyeareffectsyouth_e_outcome_data |>
  filter(
...
fraker2018threeyeareffectsyouth_e_te_continuous <- fraker2018threeyeareffectsyouth_e_outcome_data |>
...
fraker2018threeyeareffectsyouth_e_export <- bind_rows(
  fraker2018threeyeareffectsyouth_e_binary_proportions,
  fraker2018threeyeareffectsyouth_e_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  fraker2018threeyeareffectsyouth_e_export,
  file = "./es_transformation/output/fraker2018threeyeareffectsyouth_e.RDS"
)
