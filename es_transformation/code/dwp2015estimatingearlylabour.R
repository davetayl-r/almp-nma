...
dwp2015estimatingearlylabour_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "dwp2015estimatingearlylabour",
...
dwp2015estimatingearlylabour_binary_proportions <- dwp2015estimatingearlylabour_outcome_data |>
  filter(
...
dwp2015estimatingearlylabour_export <- dwp2015estimatingearlylabour_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  dwp2015estimatingearlylabour_export,
  file = "./es_transformation/output/dwp2015estimatingearlylabour.RDS"
)
