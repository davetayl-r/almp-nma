...
# Study ID: schochet2008doesjobcorps                                                         #
#============================================================================================#
...
schochet2008doesjobcorps_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "schochet2008doesjobcorps",
...
schochet2008doesjobcorps_binary_proportions <- schochet2008doesjobcorps_outcome_data |>
  filter(
...
schochet2008doesjobcorps_te_continuous <- schochet2008doesjobcorps_outcome_data |>
  filter(
...
schochet2008doesjobcorps_export <- bind_rows(
  schochet2008doesjobcorps_binary_proportions,
  schochet2008doesjobcorps_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  schochet2008doesjobcorps_export,
  file = "./es_transformation/output/schochet2008doesjobcorps.RDS"
)
