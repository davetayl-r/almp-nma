...
# Study ID: park2020evaluationyouthemployment                                                #
#============================================================================================#
...
park2020evaluationyouthemployment_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "park2020evaluationyouthemployment",
...
park2020evaluationyouthemployment_te_continuous <- park2020evaluationyouthemployment_outcome_data |>
  filter(
...
park2020evaluationyouthemployment_export <- park2020evaluationyouthemployment_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  park2020evaluationyouthemployment_export,
  file = "./es_transformation/output/park2020evaluationyouthemployment.RDS"
)
