...
# Study ID: theodos2023evaluationurbanalliance                                               #
#============================================================================================#
...
theodos2023evaluationurbanalliance_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "theodos2023evaluationurbanalliance",
...
theodos2023evaluationurbanalliance_binary_proportions <- theodos2023evaluationurbanalliance_outcome_data |>
  filter(
...
theodos2023evaluationurbanalliance_te_continuous <- theodos2023evaluationurbanalliance_outcome_data |>
  filter(
...
theodos2023evaluationurbanalliance_export <- bind_rows(
  theodos2023evaluationurbanalliance_binary_proportions,
  theodos2023evaluationurbanalliance_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  theodos2023evaluationurbanalliance_export,
  file = "./es_transformation/output/theodos2023evaluationurbanalliance.RDS"
)
