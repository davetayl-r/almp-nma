...
departmentforworkandpensions2012impactscostsbenefits_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "departmentforworkandpensions2012impactscostsbenefits",
...
departmentforworkandpensions2012impactscostsbenefits_binary_proportions <- departmentforworkandpensions2012impactscostsbenefits_outcome_data |>
  filter(
...
departmentforworkandpensions2012impactscostsbenefits_export <- departmentforworkandpensions2012impactscostsbenefits_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  departmentforworkandpensions2012impactscostsbenefits_export,
  file = "./es_transformation/output/departmentforworkandpensions2012impactscostsbenefits.RDS"
)
