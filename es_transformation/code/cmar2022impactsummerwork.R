...
# Study ID: cmar2022impactsummerwork                                                        #
#============================================================================================#
...
cmar2022impactsummerwork_outcome_data <- outcome_data |>
  filter(
...
cmar2022impactsummerwork_binary_proportions <- cmar2022impactsummerwork_outcome_data |>
  filter(
...
cmar2022impactsummerwork_mean_sd <- cmar2022impactsummerwork_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
cmar2022impactsummerwork_export <- bind_rows(
  cmar2022impactsummerwork_binary_proportions,
  cmar2022impactsummerwork_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  cmar2022impactsummerwork_export,
  file = "./es_transformation/output/cmar2022impactsummerwork.RDS"
)
