...
ghirelli2019doesonthejobtraining_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "ghirelli2019doesonthejobtraining",
...
ghirelli2019doesonthejobtraining_te_continuous <- ghirelli2019doesonthejobtraining_outcome_data |>
  filter(
...
ghirelli2019doesonthejobtraining_export <- ghirelli2019doesonthejobtraining_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  ghirelli2019doesonthejobtraining_export,
  file = "./es_transformation/output/ghirelli2019doesonthejobtraining.RDS"
)
