...
# Study ID: miller2018layingfoundationfouryear                                               #
#============================================================================================#
...
miller2018layingfoundationfouryear_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "miller2018layingfoundationfouryear",
...
miller2018layingfoundationfouryear_binary_proportions <- miller2018layingfoundationfouryear_outcome_data |>
  filter(
...
miller2018layingfoundationfouryear_te_continuous <- miller2018layingfoundationfouryear_outcome_data |>
...
miller2018layingfoundationfouryear_export <- bind_rows(
  miller2018layingfoundationfouryear_binary_proportions,
  miller2018layingfoundationfouryear_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  miller2018layingfoundationfouryear_export,
  file = "./es_transformation/output/miller2018layingfoundationfouryear.RDS"
)
