...
# Study ID: newton2018evaluation1821work_b                                                   #
#============================================================================================#
...
newton2018evaluation1821work_b_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "newton2018evaluation1821work_b",
...
newton2018evaluation1821work_b_binary_proportions <- newton2018evaluation1821work_b_outcome_data |>
  filter(
...
newton2018evaluation1821work_b_mean_sd <- newton2018evaluation1821work_b_outcome_data |>
  filter(
    esc_type == "Mean SD"
  ) |>
  # random custom function to allow custom functions to vectorise
...
newton2018evaluation1821work_b_export <- bind_rows(
  newton2018evaluation1821work_b_binary_proportions,
  newton2018evaluation1821work_b_mean_sd
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  newton2018evaluation1821work_b_export,
  file = "./es_transformation/output/newton2018evaluation1821work_b.RDS"
)
