...
# Study ID: pastore2020assessingimpactoffthejob                                              #
#============================================================================================#
...
pastore2020assessingimpactoffthejob_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "pastore2020assessingimpactoffthejob"),
...
pastore2020assessingimpactoffthejob_te_continuous <- pastore2020assessingimpactoffthejob_outcome_data |>
  filter(
...
pastore2020assessingimpactoffthejob_export <- pastore2020assessingimpactoffthejob_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  pastore2020assessingimpactoffthejob_export,
  file = "./es_transformation/output/pastore2020assessingimpactoffthejob.RDS"
)
