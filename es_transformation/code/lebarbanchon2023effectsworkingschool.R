...
# Study ID: lebarbanchon2023effectsworkingschool                                             #
#============================================================================================#
...
lebarbanchon2023effectsworkingschool_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "lebarbanchon2023effectsworkingschool",
...
lebarbanchon2023effectsworkingschool_te_continuous <- lebarbanchon2023effectsworkingschool_outcome_data |>
  filter(
...
lebarbanchon2023effectsworkingschool_export <- lebarbanchon2023effectsworkingschool_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  lebarbanchon2023effectsworkingschool_export,
  file = "./es_transformation/output/lebarbanchon2023effectsworkingschool.RDS"
)
