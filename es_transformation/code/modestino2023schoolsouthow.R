...
# Study ID: modestino2023schoolsouthow                                                       #
#============================================================================================#
...
modestino2023schoolsouthow_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "modestino2023schoolsouthow",
...
modestino2023schoolsouthow_te_continuous <- modestino2023schoolsouthow_outcome_data |>
  filter(
...
modestino2023schoolsouthow_export <- modestino2023schoolsouthow_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  modestino2023schoolsouthow_export,
  file = "./es_transformation/output/modestino2023schoolsouthow.RDS"
)
