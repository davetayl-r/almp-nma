...
# Study ID: eppel2023effectsmoreintensive                                                    #
#============================================================================================#
...
eppel2023effectsmoreintensive_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "eppel2023effectsmoreintensive",
...
eppel2023effectsmoreintensive_binary_proportions <- eppel2023effectsmoreintensive_outcome_data |>
  filter(
...
eppel2023effectsmoreintensive_te_continuous <- eppel2023effectsmoreintensive_outcome_data |>
  filter(
...
eppel2023effectsmoreintensive_export <- bind_rows(
  eppel2023effectsmoreintensive_binary_proportions,
  eppel2023effectsmoreintensive_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  eppel2023effectsmoreintensive_export,
  file = "./es_transformation/output/eppel2023effectsmoreintensive.RDS"
)
