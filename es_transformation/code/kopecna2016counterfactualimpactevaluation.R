...
kopecna2016counterfactualimpactevaluation_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "kopecna2016counterfactualimpactevaluation",
...
kopecna2016counterfactualimpactevaluation_binary_proportions <- kopecna2016counterfactualimpactevaluation_outcome_data |>
  filter(
...
kopecna2016counterfactualimpactevaluation_te_continuous <- kopecna2016counterfactualimpactevaluation_outcome_data |>
  filter(
...
kopecna2016counterfactualimpactevaluation_export <- bind_rows(
  kopecna2016counterfactualimpactevaluation_binary_proportions,
  kopecna2016counterfactualimpactevaluation_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  kopecna2016counterfactualimpactevaluation_export,
  file = "./es_transformation/output/kopecna2016counterfactualimpactevaluation.RDS"
)
