...
# Study ID: mcleod2016evaluationimpactyouth                                                  #
#============================================================================================#
...
mcleod2016evaluationimpactyouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "mcleod2016evaluationimpactyouth"),
...
mcleod2016evaluationimpactyouth_te_continuous <- mcleod2016evaluationimpactyouth_outcome_data |>
  filter(
...
mcleod2016evaluationimpactyouth_export <- mcleod2016evaluationimpactyouth_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  mcleod2016evaluationimpactyouth_export,
  file = "./es_transformation/output/mcleod2016evaluationimpactyouth.RDS"
)
