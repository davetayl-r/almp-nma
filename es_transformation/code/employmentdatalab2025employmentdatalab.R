...
# Study ID: employmentdatalab2025employmentdatalab                                           #
#============================================================================================#
...
employmentdatalab2025employmentdatalab_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "employmentdatalab2025employmentdatalab",
...
employmentdatalab2025employmentdatalab_binary_proportions <- employmentdatalab2025employmentdatalab_outcome_data |>
  filter(
...
employmentdatalab2025employmentdatalab_te_continuous <- employmentdatalab2025employmentdatalab_outcome_data |>
...
employmentdatalab2025employmentdatalab_export <- bind_rows(
  employmentdatalab2025employmentdatalab_binary_proportions,
  employmentdatalab2025employmentdatalab_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  employmentdatalab2025employmentdatalab_export,
  file = "./es_transformation/output/employmentdatalab2025employmentdatalab.RDS"
)
