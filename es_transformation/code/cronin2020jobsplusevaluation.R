...
# Study ID: cronin2020jobsplusevaluation                                                     #
#============================================================================================#
...
cronin2020jobsplusevaluation_outcome_data <- outcome_data |>
  filter(
...
cronin2020jobsplusevaluation_binary_proportions <- cronin2020jobsplusevaluation_outcome_data |>
  filter(
...
cronin2020jobsplusevaluation_export <- cronin2020jobsplusevaluation_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  cronin2020jobsplusevaluation_export,
  file = "./es_transformation/output/cronin2020jobsplusevaluation.RDS"
)
