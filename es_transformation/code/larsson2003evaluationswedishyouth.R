...
# Study ID: larsson2003evaluationswedishyouth                                                #
#============================================================================================#
...
larsson2003evaluationswedishyouth_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "larsson2003evaluationswedishyouth"),
...
larsson2003evaluationswedishyouth_te_continuous <- larsson2003evaluationswedishyouth_outcome_data |>
  filter(
...
larsson2003evaluationswedishyouth_export <- larsson2003evaluationswedishyouth_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  larsson2003evaluationswedishyouth_export,
  file = "./es_transformation/output/larsson2003evaluationswedishyouth.RDS"
)
