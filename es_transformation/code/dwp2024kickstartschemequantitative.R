...
dwp2024kickstartschemequantitative_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "dwp2024kickstartschemequantitative",
...
dwp2024kickstartschemequantitative_binary_proportions <- dwp2024kickstartschemequantitative_outcome_data |>
  filter(
...
dwp2024kickstartschemequantitative_export <- dwp2024kickstartschemequantitative_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  dwp2024kickstartschemequantitative_export,
  file = "./es_transformation/output/dwp2024kickstartschemequantitative.RDS"
)
