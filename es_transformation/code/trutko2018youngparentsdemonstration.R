...
# Study ID: trutko2018youngparentsdemonstration                                              #
#============================================================================================#
...
trutko2018youngparentsdemonstration_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    str_detect(study_id, "trutko2018youngparentsdemonstration"),
...
trutko2018youngparentsdemonstration_binary_proportions <- trutko2018youngparentsdemonstration_outcome_data |>
  filter(
...
trutko2018youngparentsdemonstration_te_continuous <- trutko2018youngparentsdemonstration_outcome_data |>
  filter(
...
trutko2018youngparentsdemonstration_export <- bind_rows(
  trutko2018youngparentsdemonstration_binary_proportions,
  trutko2018youngparentsdemonstration_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  trutko2018youngparentsdemonstration_export,
  file = "./es_transformation/output/trutko2018youngparentsdemonstration.RDS"
)
