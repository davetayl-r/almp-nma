...
# Study ID: nafilyan2014youthcontractprovision                                               #
#============================================================================================#
...
nafilyan2014youthcontractprovision_outcome_data <- outcome_data |>
  filter(
...
nafilyan2014youthcontractprovision_binary_proportions <- nafilyan2014youthcontractprovision_outcome_data |>
  filter(
...
nafilyan2014youthcontractprovision_export <- nafilyan2014youthcontractprovision_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  nafilyan2014youthcontractprovision_export,
  file = "./es_transformation/output/nafilyan2014youthcontractprovision.RDS"
)
