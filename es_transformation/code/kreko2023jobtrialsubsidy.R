...
# Study ID: kreko2023jobtrialsubsidy                                                         #
#============================================================================================#
...
kreko2023jobtrialsubsidy_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "kreko2023jobtrialsubsidy",
...
kreko2023jobtrialsubsidy_te_continuous <- kreko2023jobtrialsubsidy_outcome_data |>
  filter(
...
kreko2023jobtrialsubsidy_export <- kreko2023jobtrialsubsidy_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  kreko2023jobtrialsubsidy_export,
  file = "./es_transformation/output/kreko2023jobtrialsubsidy.RDS"
)
