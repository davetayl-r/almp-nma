...
# Study ID: mcclanahan2004enrichingsummerwork                                                        #
#============================================================================================#
...
mcclanahan2004enrichingsummerwork_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "mcclanahan2004enrichingsummerwork",
...
mcclanahan2004enrichingsummerwork_binary_proportions <- mcclanahan2004enrichingsummerwork_outcome_data |>
  filter(
...
mcclanahan2004enrichingsummerwork_export <- mcclanahan2004enrichingsummerwork_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  mcclanahan2004enrichingsummerwork_export,
  file = "./es_transformation/output/mcclanahan2004enrichingsummerwork.RDS"
)
