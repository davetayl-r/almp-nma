...
# Study ID: theodos2017pathwayshighschool                                                    #
#============================================================================================#
...
theodos2017pathwayshighschool_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "theodos2017pathwayshighschool",
...
theodos2017pathwayshighschool_binary_proportions <- theodos2017pathwayshighschool_outcome_data |>
  filter(
...
theodos2017pathwayshighschool_te_continuous <- theodos2017pathwayshighschool_outcome_data |>
  filter(
...
theodos2017pathwayshighschool_export <- bind_rows(
  theodos2017pathwayshighschool_binary_proportions,
  theodos2017pathwayshighschool_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  theodos2017pathwayshighschool_export,
  file = "./es_transformation/output/theodos2017pathwayshighschool.RDS"
)
