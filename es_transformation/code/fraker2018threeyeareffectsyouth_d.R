...
# Study ID: fraker2018threeyeareffectsyouth_d                                                #
#============================================================================================#
...
fraker2018threeyeareffectsyouth_d_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "fraker2018threeyeareffectsyouth_d",
...
fraker2018threeyeareffectsyouth_d_binary_proportions <- fraker2018threeyeareffectsyouth_d_outcome_data |>
  filter(
...
fraker2018threeyeareffectsyouth_d_te_continuous <- fraker2018threeyeareffectsyouth_d_outcome_data |>
...
fraker2018threeyeareffectsyouth_d_export <- bind_rows(
  fraker2018threeyeareffectsyouth_d_binary_proportions,
  fraker2018threeyeareffectsyouth_d_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  fraker2018threeyeareffectsyouth_d_export,
  file = "./es_transformation/output/fraker2018threeyeareffectsyouth_d.RDS"
)
