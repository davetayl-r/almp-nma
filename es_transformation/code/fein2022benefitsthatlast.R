...
# Study ID: fein2022benefitsthatlast                                                         #
#============================================================================================#
...
fein2022benefitsthatlast_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "fein2022benefitsthatlast",
...
fein2022benefitsthatlast_binary_proportions <- fein2022benefitsthatlast_outcome_data |>
  filter(
...
fein2022benefitsthatlast_te_continuous <- fein2022benefitsthatlast_outcome_data |>
  filter(
...
fein2022benefitsthatlast_export <- bind_rows(
  fein2022benefitsthatlast_binary_proportions,
  fein2022benefitsthatlast_te_continuous
) |>
  select(
    study_id,
    outcome_domain,
...
# export data
saveRDS(
  fein2022benefitsthatlast_export,
  file = "./es_transformation/output/fein2022benefitsthatlast.RDS"
)
