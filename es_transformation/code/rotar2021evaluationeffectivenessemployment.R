...
# Study ID: rotar2021evaluationeffectivenessemployment                                                        #
#============================================================================================#
...
rotar2021evaluationeffectivenessemployment_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "rotar2021evaluationeffectivenessemployment",
...
rotar2021evaluationeffectivenessemployment_te_continuous <- rotar2021evaluationeffectivenessemployment_outcome_data |>
  filter(
...
rotar2021evaluationeffectivenessemployment_export <- rotar2021evaluationeffectivenessemployment_te_continuous |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  rotar2021evaluationeffectivenessemployment_export,
  file = "./es_transformation/output/rotar2021evaluationeffectivenessemployment.RDS"
)
