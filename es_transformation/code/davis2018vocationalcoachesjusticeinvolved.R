...
# Study ID: davis2018vocationalcoachesjusticeinvolved                                        #
#============================================================================================#
...
davis2018vocationalcoachesjusticeinvolved_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "davis2018vocationalcoachesjusticeinvolved",
...
davis2018vocationalcoachesjusticeinvolved_binary_proportions <- davis2018vocationalcoachesjusticeinvolved_outcome_data |>
  filter(
...
davis2018vocationalcoachesjusticeinvolved_export <- davis2018vocationalcoachesjusticeinvolved_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  davis2018vocationalcoachesjusticeinvolved_export,
  file = "./es_transformation/output/davis2018vocationalcoachesjusticeinvolved.RDS"
)
