...
crepon2013labormarketpolicies_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "crepon2013labormarketpolicies",
...
crepon2013labormarketpolicies_binary_proportions <- crepon2013labormarketpolicies_outcome_data |>
  filter(
...
crepon2013labormarketpolicies_export <- crepon2013labormarketpolicies_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  crepon2013labormarketpolicies_export,
  file = "./es_transformation/output/crepon2013labormarketpolicies.RDS"
)
