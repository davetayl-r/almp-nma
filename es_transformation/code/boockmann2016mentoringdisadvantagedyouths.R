...
boockmann2016mentoringdisadvantagedyouths_outcome_data <- outcome_data |>
  filter(
    # filter data by study id
    study_id == "boockmann2016mentoringdisadvantagedyouths",
...
boockmann2016mentoringdisadvantagedyouths_binary_proportions <- boockmann2016mentoringdisadvantagedyouths_outcome_data |>
  filter(
...
boockmann2016mentoringdisadvantagedyouths_export <- boockmann2016mentoringdisadvantagedyouths_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  boockmann2016mentoringdisadvantagedyouths_export,
  file = "./es_transformation/output/boockmann2016mentoringdisadvantagedyouths.RDS"
)
