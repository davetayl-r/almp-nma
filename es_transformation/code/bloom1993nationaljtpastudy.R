...
# Study ID: bloom1993nationaljtpastudy                                                       #
#============================================================================================#
...
bloom1993nationaljtpastudy_outcome_data <- outcome_data |>
  filter(
...
bloom1993nationaljtpastudy_binary_proportions <- bloom1993nationaljtpastudy_outcome_data |>
  filter(
...
bloom1993nationaljtpastudy_export <- bloom1993nationaljtpastudy_binary_proportions |>
  select(
    study_id,
    outcome_domain,
    outcome,
...
# export data
saveRDS(
  bloom1993nationaljtpastudy_export,
  file = "./es_transformation/output/bloom1993nationaljtpastudy.RDS"
)
